...
//---------- Akcje publiczne -------------
if(isset($_POST['useridL']) and $_POST['useridL']!="" and isset($_POST['pass'])){
   if( !$this->login($_POST['useridL'],$_POST['pass']) ){
      $data["error1"]=$this->error;
   }
}
if(isset($_POST['useridR']) and $_POST['pass1']!="" and ($_POST['pass1']==$_POST['pass2'])){
   if( !$this->captcha->checkCaptcha(strtoupper($_POST['captcha']))) {
      $data["error2"]="Wpisano niewłaściwy kod Captcha";
   }else{
      if( !$this->register($_POST['useridR'],$_POST['username'],$_POST['pass1']) )
